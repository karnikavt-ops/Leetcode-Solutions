<h2><a href="https://leetcode.com/problems/string-compression/?envType=problem-list-v2&envId=wmjkndj5">443. String Compression</a></h2><h3>Medium</h3><hr><p>Given an array of characters <code>chars</code>, compress it using the following algorithm:</p>
